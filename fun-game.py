...
country = input("Moving to Country? ")
pluralNoun = input("Passionate about? ")
verb = input("What you will do at your job? ")
adjective = input("Professional quality? ")
item = input("Name a personal item? ")
holiday = input("Favorite Holiday? ")
name = input("Your name? ")
print(prose.replace("OCCUPATION", occupation)
.replace("COUNTRY", country)
.replace("PLURAL_NOUN", pluralNoun)
.replace("VERB", verb)
.replace("ADJECTIVE", adjective)
.replace("PERSONAL_ITEM", item)
